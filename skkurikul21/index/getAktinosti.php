...
if ($vrstaAktivnosti_ID != -1) {
        ...
        WHERE sk_prava.KorisnikID = ? AND sk_aktivnosti.VrstaID = ? AND Aktivno = 1 AND sk_aktivnost.Obrisano = 0;";
        ...
        FROM sk_aktivnost 
        JOIN sk_prava ON sk_aktivnost.ID = sk_prava.AktivnostID
        WHERE sk_prava.KorisnikID = ? AND Aktivno = 1 AND sk_aktivnost.Obrisano = 0;";
