...
function Save() {
    ...
    if(appState.novaAktivnost){
        alert("Kreira se nova aktivnost!");
        let php_url = "novaAktivnost.php"
    }
    else{
        let php_url = "save.php";
    }

    $.ajax({
        url: "novaAktivnost.php",
        method: "POST",
        data: {
            user_ID: user_ID,
        ...
        //return brojeke -> 1 -> spremljeno uspjesno, 2 -> nemate prava; 3 -> kreirana nova aktinosti
           alert(odgovor["pravo"]);
        },
        error: function () {
