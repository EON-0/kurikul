...
document.addEventListener('DOMContentLoaded', function () {
    ...
    setTimeout(podsjetnikNaOdmor, 10 * 60 * 1000); // timeOut
    ...
    function setupRadioFieldHandlers(addId, removeId, editId, containerId, fieldName, promptText) {
        ...
        addButton.addEventListener("click", function () {
            ...
            if (text) {
                // Count existing radio buttons to determine the next index
                const count = document.querySelectorAll(`input[name="${fieldName}"]`).length;
                
                const radio = document.createElement('input');
                radio.type = 'radio';
                radio.id = `${fieldName}-` + 0; 
                ...
                const lineBreak = document.createElement('br'); //za preglednost
    ...
    // Apply to all sections with separate container IDs and field names
    setupRadioFieldHandlers("add-goal", "remove-goal", "edit-goal", "list-goals", "goal", "Unesite cilj:");
    setupRadioFieldHandlers("add-realization", "remove-realization", "edit-realization", "list-realizations", "realization", "Unesite način realizacije:");
    setupRadioFieldHandlers("add-evaluation", "remove-evaluation", "edit-evaluation", "list-evaluation", "evaluation", "Unesite način vrednovanja:");
    setupRadioFieldHandlers("add-expense", "remove-expense", "edit-expense", "expenses", "expense", "Unesite trošak:");
